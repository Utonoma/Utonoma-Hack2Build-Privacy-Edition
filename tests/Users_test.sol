...
contract Users_test is Users, Comparators {
    ...
    */   
    ...
    function calculateMAUForASingleUser() public {
        ...
        MAUReport.push(1);//MAUReport should be [1]
        Assert.ok(
        ...
        MAUReport.push(1); //MAUReport should be [1,1]
        Assert.ok(
            arrayComparator(getMAUReport(), MAUReport),
    ...
    function calculateMAUForTwoUsers() public {
        ...
        MAUReport[MAUReport.length - 1]++; //MAUReport should be [1,1,0,1,0,0,0,1,2]
        Assert.ok(
            arrayComparator(getMAUReport(), MAUReport),
    ...
    function calculateMAUForThreeUsers() public {
        ...
        MAUReport[MAUReport.length - 1]++; //MAUReport should be [1,1,0,1,0,0,0,1,3]
        Assert.ok(
            arrayComparator(getMAUReport(), MAUReport),
